...
function animate(){
    ...
    tl.addLabel('start')
      ...
      .to('#phone1', 0.75, { y: 0, ease: Power1.easeInOut })
      .staggerTo('#t1 > span', 0.5, { autoAlpha: 1, y: 0, ease: Power1.easeInOut }, 0.1, "-=0.33")
      .staggerTo('#t1 > span', 0.5, { autoAlpha: 0, y: -5, ease: Power1.easeInOut }, 0.1, "+=2.5")
      .to('#phone1', 0.75, { y: '100%', ease: Power1.easeInOut }, "-=0.5")
      .to('#phone2', 0.75, { y: 0, ease: Power1.easeInOut })
      .staggerTo('#t2 > span', 0.5, { autoAlpha: 1, y: 0, ease: Power1.easeInOut }, 0.1, "-=0.33")
      .staggerTo('#t2 > span', 0.5, { autoAlpha: 0, y: -5, ease: Power1.easeInOut }, 0.1, "+=2.5")
