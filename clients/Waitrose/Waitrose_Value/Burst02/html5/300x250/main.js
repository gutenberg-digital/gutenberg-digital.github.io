...
function animate() {
    ...
    tl.set(["#end_frame"], { y: 12, force3D: true, rotation: .001 });
    ...
    tl.to(["#end_frame"], 1, { autoAlpha: 0, ease: Power1.easeInOut }, "+=2");

    tl.set(["#end_frame"], { y: 0, force3D: true, rotation: .001 });

    tl.staggerTo([".prod"], 1, { autoAlpha: 1, stagger: 0.5, ease: Power1.easeInOut }, "+=0");

    tl.to(["#products_holder"], 11, { x: -800, ease: "none" }, 4);

    tl.to(["#cta", "#end_frame"], 1, { autoAlpha: 1, ease: Power1.easeInOut }, "-=.7");
