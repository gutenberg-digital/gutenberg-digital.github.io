...
function animate() {
    ...
    tl.set(["#product1", "#product2", "#product3", "#product4", "#product5", "#product6", "#product7", "#product8"], { force3D: true, rotation: .001 });
    ...
    tl.set(["#bg1"], { y: 90, force3D: true, rotation: .001 });

    tl.set(["#bg2"], { y: -90, force3D: true, rotation: .001 });


    tl.set(["#main_content"], { autoAlpha: 1, force3D: true, rotation: .001 }, "+=0");

    tl.to(["#bg1"], .7, { y: 0, ease: Power1.easeOut }, "+=0");

    tl.to(["#bg2"], .7, { y: 0, ease: Power1.easeOut }, "-=.7");
    ...
    tl.to(["#products_holder"], 14, { x: -740, ease: "none" }, .5);

    tl.to(["#product1_holder"], 1, { autoAlpha: 0, ease: Power1.easeInOut }, 3.6);

    tl.to(["#product2_holder"], 1, { autoAlpha: 0, ease: Power1.easeInOut }, 7);

    tl.to(["#product3_holder", "#grad"], 1, { autoAlpha: 0, ease: Power1.easeInOut }, 10.5);

    tl.to(["#cta"], .5, { autoAlpha: 1, ease: Power1.easeInOut }, 14);
