...
function animate(){
    ...
    tl.addLabel('start')
      ...
      .to(['#bg', '#target'], 0.5, { y: "-=66", ease: Power1.easeInOut }, '-=0.75')
      ...
      .to(['#bg'], 0.5, { x: "+=450", y: "+=65", height: "-=90", width: "-=364", ease: Power1.easeInOut }, '-=0.5')
      .to(['#target'], 0.5, { x: "+=240", y: "+=9", scale: 0.6, ease: Power1.easeInOut }, '-=0.5')
