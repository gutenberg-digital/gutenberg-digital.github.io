...
function animate(){
    ...
    tl.addLabel('start')
      ...
      .to(['#bg'], 0.75, { y: "-=125", x: "-=33", width: "+=100", height: "+=150", ease: Power1.easeInOut }, '-=0.75')
      .to(['#target'], 0.75, { y: "-=8", x: "+=41", ease: Power1.easeInOut }, '-=0.75')
      ...
      .to('#text_container', 0.75, { y: -0, ease: Power1.easeInOut }, "+=0")
      //  Revert back to original logo colours
      .to(iamsLogoPaths, 0.75, { fill: '#878787' }, '-=0.75')
      .to(['#bg', '#target'], 0.75, { y: "+=65", x: "+=0", ease: Power1.easeInOut }, '-=0.75')
