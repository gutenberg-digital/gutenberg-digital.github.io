...
function animate(){
    ...
    tl.addLabel('start')
      ...
      .to(['#bg'], 0.75, { scale: 1.53, y: "+=10", ease: Power1.easeInOut }, '-=0.75')
      ...
      .to(['#bg'], 0.75, { x: "+=333", ease: Power1.easeInOut }, '-=0.75')
      .to(['#target'], 0.75, { x: "+=333", scale: 0.8, ease: Power1.easeInOut }, '-=0.75')
