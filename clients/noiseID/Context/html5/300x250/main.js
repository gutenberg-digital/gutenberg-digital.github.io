...
function animate(){
    ...
    tl.addLabel('start')
      ...
      .to('#logo', 0, { scale: 0.7, x: -88, y: -72, ease: Power1.easeInOut })
      ...
      .to('#target', 0.67, { scale: 1, x: 5, y: -5, ease: Power4.easeOut }, "-=0.5")
      ...
      .to(['#bg'], 0.75, { x: "-=10", y: "-=50", height: "+=50", width: "+=50", ease: Power1.easeInOut }, '-=0.75')
      .to(['#target'], 0.75, { x: "+=37", y: "-=15", ease: Power1.easeInOut }, '-=0.75')
