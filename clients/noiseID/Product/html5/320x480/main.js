...
function animate(){
    ...
    tl.addLabel('start')
      ...
      .to(['#bg'], 0.75, { scale: 1.61, x: "-=40", ease: Power1.easeInOut }, '-=0.75')
      ...
      .to(['#bg', '#target'], 0.75, { y: "+=105", ease: Power1.easeInOut }, '-=0.75')
      ...
      .to('#text_container', 0.75, { y: "+=65", ease: Power1.easeInOut }, "+=0")
      .to(['#bg', '#target'], 0.75, { y: "+=65", ease: Power1.easeInOut }, '-=0.75')
      .to('#cta', 0.5, { autoAlpha: 1, y: 0, ease: Power1.easeInOut }, "+=0")
